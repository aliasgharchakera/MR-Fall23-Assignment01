...
\begin{questions}
    ...
    \begin{parts}
        ...
        \begin{solution}
            ...
            The distance from the wheel to the center of the robot will be considered as l. $V_z$ will always be 0 because the robot is constrained to move in x-y plane due to the robot always being on the plane.  
            ...
            The steering angles $\beta_i$, where i = 1, 2, 3 are determined by the following equations:
            ...
            substituting the subsequent values of $V_{1x}$ and $V_{1y}$ in the above equation:
            ...
            substituting the subsequent values of $V_{2x}$ and $V_{2y}$ in the above equation:
            ...
            substituting the subsequent values of $V_{3x}$ and $V_{3y}$ in the above equation:
